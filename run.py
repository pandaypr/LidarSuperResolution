...
from data import *
def test():
    training_data_input, training_data_pred_ground_truth = load_test_data()
    new_model = tf.keras.models.load_model(r"C:\Users\ppanday\Downloads\lidar_super_resolution-master\lidar_super_resolution-master\weights.h5")
    new_model.summary()
    new_model.compile()
    O =new_model.predict(training_data_input)
    return O 
